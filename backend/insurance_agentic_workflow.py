...
if __name__ == '__main__':
    ...
    "accident involving a school bus and a passenger vehicle on a residential street. "
    "The school bus seems to have collided with the front of a white sedan. "
    "The sedan has extensive front-end damage, suggesting a forceful impact occurred."
)
